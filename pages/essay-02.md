...
{% include feature/line-chart.html data="party-platforms-1948-2000-all" topic=" Issues" %}

This graph shows how public issues rose to its highest importance in 1972 and then tapered off. This also aligns with the actions of the NAACP in tapering off through the end of the 20th century. They were (and continue to this day) still out there fighting for and encouraging the African American communities, but the operations maybe were not as important to the general public.
